...
DEFAULT_SVS_DIR = '/drobo/YERKES_IMAGE_TRANSFER/'
DEFAULT_PYRAMID_DIR = '/drobo/PYRAMIDS/YERKES_IMAGE_TRANSFER/'
DEFAULT_JPEG_DIR = '/drobo/JPEG_CACHE/YERKES_IMAGE_TRANSFER/'
		...
		for fname in filenames:
			...
			if svs_pat.match(fname):
				...
				if os.path.isfile(pyramid_path):
					...
					print "vips im_vips2tiff ",dirpath+"/"+fname,pyramid_path+":jpeg:75,tile:256x256,pyramid,,,,8"	
