...
$ROOT_DIR = "/drobo/TCGA_IMAGE_MIRROR/RAW_SLIDE_LINKS/";

## the pyramid root dir mirrors the directory structure of the RAW slide links... so i can keep the organization consistent
$THUMB_ROOT_DIR = "/drobo/TCGA_IMAGE_MIRROR/THUMBS/";
$PYRAMID_ROOT_DIR = "/drobo/TCGA_IMAGE_MIRROR/PYRAMIDS/";

#@SVS_FILES_TO_PROCESS = `find -L ${ROOT_DIR}bcrTCGA*/* -name *.svs`;
@SVS_FILES_TO_PROCESS = `find -L ${ROOT_DIR}KIRC/* -name *.svs`;
