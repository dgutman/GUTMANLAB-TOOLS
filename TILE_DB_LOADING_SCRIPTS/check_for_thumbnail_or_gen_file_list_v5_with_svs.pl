...
require 'dg_helper_functions_for_thumbnails.pl';

&connect_to_mysql_v2();

@NDPI_FILES_TO_CHECK = glob("/STORAGE01-VG2/Images/*/*.ndpi");
$ROOT_DIR = "/STORAGE01-VG2/Images/";
$THUMBNAIL_DEPOT = "/IMAGING_SCRATCH/THUMBNAIL_DEPOT/";
$WINDOWS_ROOT_PATH = "V:/THUMBNAIL_DEPOT/";
...
#@SVS_FILES_TO_CHECK = glob("/STORAGE01-VG2/Images/bcrTCGA/*/*/*.svs");
...
@SVS_FILES_TO_CHECK = (@SVS_FILES_TO_CHECK , glob("/IMAGING_SCRATCH/THUMBNAIL_DEPOT/RAW_SLIDE_LINKS/*/*/*.svs") ,glob("/IMAGING_SCRATCH/THUMBNAIL_DEPOT/RAW_SLIDE_LINKS/bcrTCGA-HE/*/*.svs") );

@SVS_FILES_TO_CHECK = (@SVS_FILES_TO_CHECK , 
glob("/IMAGING_SCRATCH/THUMBNAIL_DEPOT/RAW_SLIDE_LINKS/*/*/*.svs") ,glob("/IMAGING_SCRATCH/THUMBNAIL_DEPOT/RAW_SLIDE_LINKS/bcrTCGA-FS/*/*.svs") );
