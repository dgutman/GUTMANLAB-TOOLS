...
#/data2/Images/ValidationSet/40X_1024x1024_tiles/oligoastroII.1.ndpi
...
#		$statement .= sprintf "%s.svs-%010d-%010d.%s ", $TILE_ROOT,$x,$y,$img_extension_type;

		$current_jpg_file = sprintf "%s.svs-%010d-%010d.tiff.grid4.%s", $TILE_ROOT,$x,$y,$img_extension_type;
